import { p as ui, a as ci, r as li } from "../share.js";
import { B as $i, c as Ti, e as Ci, f as Pi, g as Ri, C as Ai, j as Si, k as Fi, E as Ei, G as Oi, I as ki, L as Di, M as Mi, R as ji, w as Wi, T as Ii, Z as Bi, b as Ui, h as Vi, i as Hi, l as Ni, m as Li, d as xi, n as zi, o as Zi, q as Gi, s as Xi, t as Yi, u as qi, v as Ki, x as Ji, y as Qi } from "../share.js";
async function Mr(A = {}) {
    ...
    V([r], a, (s) => {
      var o = {};
      {
        ...
        for (let c = 0; c < u.length; ++c) {
          const f = u[c], v = s[c], y = f.getter, b = f.getterContext, C = s[c + i.length], T = f.setter, w = f.setterContext;
          o[f.fieldName] = {
  ...
  var st = (r, e, t, n) => {
    ...
    return e;
  }, Yr = (e) => Cr.unregister(e), J(r)) : (J = (e) => e, r), ct = () => {
    let r = cr.prototype;
    Object.assign(r, {
      isAliasOf(t) {
  ...
  function fr(r, e, t, n, i, a, s, o, u, c, f) {
    this.name = r, this.registeredClass = e, this.isReference = t, this.isConst = n, this.isSmartPointer = i, this.pointeeType = a, this.sharingPolicy = s, this.rawGetPointee = o, this.rawConstructor = u, this.rawShare = c, this.rawDestructor = f, !i && e.baseClass === void 0 ? n ? (this.toWireType = pt, this.destructorFunction = null) : (this.toWireType = _t, this.destructorFunction = null) : this.toWireType = ht;
  }
  var ee = (r, e, t) => {
  ...
  }, Rt = (r, e, t, n, i, a, s, o, u, c, f, v, y) => {
    f = P(f), a = S(i, a), o && (o = S(s, o)), c && (c = S(u, c)), y = S(v, y);
    var b = vt(f);
    Qr(b, function() {
      vr(`Cannot construct ${f} due to unbound types`, [n]);
    }), V([r, e, t], n ? [n] : [], (C) => {
      C = C[0];
      var T, w;
      ...
      var m = Pr(f, function() {
        if (Object.getPrototypeOf(this) !== F)
          throw new K(`Use 'new' to construct ${f}`);
        if (R.constructor_body === void 0)
          throw new K(`${f} has no accessible constructor`);
        for (var Re = arguments.length, pr = new Array(Re), hr = 0; hr < Re; hr++)
          pr[hr] = arguments[hr];
        var Ae = R.constructor_body[pr.length];
        if (Ae === void 0)
          throw new K(`Tried to invoke ctor of ${f} with invalid number of parameters (${pr.length}) - expected (${Object.keys(R.constructor_body).toString()}) parameters instead!`);
  ...
  function Fr(r, e, t, n, i, a) {
    ...
    var o = e[1] !== null && t !== null, u = At(e), c = !e[0].isVoid, f = s - 2, v = new Array(f), y = [], b = [], C = function() {
      b.length = 0;
      var T;
  ...
  var St = (r, e, t, n, i, a) => {
    ...
    i = S(n, i), V([], [r], (o) => {
      ...
      }, V([], s, (c) => (c.splice(1, 0, null), o.registeredClass.constructor_body[e - 1] = Fr(u, c, null, i, a), [])), [];
    });
  }, ie = (r) => {
    r = r.trim();
    const e = r.indexOf("(");
    return e === -1 ? r : r.slice(0, e);
  }, Ft = (r, e, t, n, i, a, s, o, u, c) => {
    var f = Sr(t, n);
    e = P(e), e = ie(e), a = S(i, a), V([], [r], (v) => {
      ...
      function b() {
        vr(`Cannot call ${y} due to unbound types`, f);
      }
      var C = v.registeredClass.instancePrototype, T = C[e];
      return T === void 0 || T.overloadTable === void 0 && T.className !== v.name && T.argCount === t - 2 ? (b.argCount = t - 2, b.className = v.name, C[e] = b) : (Jr(C, e, y), C[e].overloadTable[t - 2] = b), V([], f, (w) => {
        var m = Fr(y, w, v, a, s);
    ...
    r = P(r), r = ie(r), i = S(n, i), Qr(r, function() {
      ...
      return ee(r, Fr(r, f, null, i, a), e - 1), [];
    });
  }, Mt = (r, e, t) => {
    switch (e) {
      case 1:
    ...
    return e;
  }, ue = globalThis.TextDecoder && new TextDecoder(), ce = (r, e, t, n) => {
    var i = e + t;
    if (n) return i;
    for (; r[e] && !(e >= i); ) ++e;
    return e;
  ...
  }, fe = globalThis.TextDecoder ? new TextDecoder("utf-16le") : void 0, Nt = (r, e, t) => {
    var n = r >> 1, i = ce(X, n, e / 2, t);
    if (i - n > 16 && fe) return fe.decode(X.subarray(n, i));
    for (var a = "", s = n; s < i; ++s) {
      var o = X[s];
    ...
    e === 2 ? (n = Nt, i = Lt, a = xt) : (n = zt, i = Zt, a = Gt), E(r, {
      ...
      toWireType: (s, o) => {
        ...
        var u = a(o), c = Dr(4 + u + e);
        return $[c >> 2] = u / e, i(o, c + 4, u + e), s !== null && s.push(I, c), c;
      },
      readValueFromPointer: q,
    ...
    var u = new Array(r), c = (v, y, b, C) => {
      ...
      return en(s, b, m);
    }, f = `methodCaller<(${a.map((v) => v.name)}) => ${i.name}>`;
    return Jt(Pr(f, c));
  ...
  }, ln = () => 2147483648, fn = (r, e) => Math.ceil(r / e) * e, vn = (r) => {
    ...
    for (var n = 1; n <= 4; n *= 2) {
      ...
      var a = Math.min(t, fn(Math.max(r, i), 65536)), s = vn(a);
      if (s)
        return !0;
    }
    return !1;
  ...
  if (ct(), wt(), l.noExitRuntime && l.noExitRuntime, l.print && (Br = l.print), l.printErr && (L = l.printErr), l.wasmBinary && (G = l.wasmBinary), l.arguments && l.arguments, l.thisProgram && (Wr = l.thisProgram), l.preInit)
  ...
  function Mn(r, e, t, n, i, a, s, o, u, c, f) {
    var v = h();
    try {
      _(r)(e, t, n, i, a, s, o, u, c, f);
    } catch (y) {
  ...
  function Wn(r, e, t, n, i, a, s, o, u, c, f, v, y, b, C, T, w) {
    var m = h();
    try {
      _(r)(e, t, n, i, a, s, o, u, c, f, v, y, b, C, T, w);
    } catch (F) {
  ...
  function Kn(r, e, t, n, i, a, s, o, u, c) {
    var f = h();
    try {
      _(r)(e, t, n, i, a, s, o, u, c);
    } catch (v) {
      if (p(f), v !== v + 0) throw v;
      d(1, 0);
    }
  }
  function Jn(r, e, t) {
  ...
  function ti(r, e, t, n, i, a, s, o, u, c, f, v) {
    var y = h();
    try {
      return _(r)(e, t, n, i, a, s, o, u, c, f, v);
    } catch (b) {
      if (p(y), b !== b + 0) throw b;
      d(1, 0);
    }
  }
  function ni(r, e, t, n, i, a, s, o, u, c, f, v, y, b, C, T) {
    var w = h();
    try {
      _(r)(e, t, n, i, a, s, o, u, c, f, v, y, b, C, T);
    } catch (m) {
...
const mi = "c25c09c3a8ec3118f96d224491c9a20cc6ad4302b70eb0e4b941772c2982a920";
export {
